function promiseResponse(request) {
  console.log("promiseResponse request", request);
  const crmclient = require("./ZCRMRestClient");
  const OAuth = require("./OAuth");

  return new Promise(function (resolve, reject) {
    const mysql_util = { ...crmclient.getMySQLModule() };
...
function makeapicall(request) {
  console.log("makeapicall request", request);
  return new Promise(function (resolve, reject) {
    const crmclient = require("./ZCRMRestClient");
...
function constructRequestDetails(input, url, type, isModuleParam) {
  console.log("constructRequestDetails input", input);
  ...
  console.log("constructRequestDetails requestDetails", requestDetails);
